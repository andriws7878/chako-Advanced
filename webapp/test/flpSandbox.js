		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employees",
									"targetURL": "#chakoappemployees-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"chakoappemployees-display": {
								"semanticObject": "chakoappemployees",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=chakoapp.employees",
									"url": sap.ui.require.toUrl("chakoapp/employees")
								}
							}
						}
					}
